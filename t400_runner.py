...
class Runner:
    ...
    def draw(self):
        ...
        sx, sy = self.x - server.t400_background.window_left, self.y - server.t400_background.window_bottom
        ...
        self.font_time.draw(22, 540, f'400M', (0, 0, 0))
    ...
    def record_lap_time(self):
        ...
        if self.start_time is not None:
            ...
            server.lap_times.append(('400M', lap_time_formatted))
